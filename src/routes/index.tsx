...
const TotalInvoice = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalInvoice'));
const TotalInvoiceAmount = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalInvoiceAmount'));
const TotalReveivedAmount = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalReveivedAmount'));
const TotalSalesDue = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalSalesDue'));
const TotalSales = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalSales'));
const Revenue = React.lazy(() => import('../pages/farmer-dashboard/dashboard/Revenue'));
const TotalCustomers = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalCustomers'));
const TotalExpenses = React.lazy(() => import('../pages/farmer-dashboard/dashboard/TotalExpenses'));
const QuotationReceived = React.lazy(() => import('../pages/farmer-dashboard/dashboard/QuotationReceived'));
const AcceptedOrders = React.lazy(() => import('../pages/farmer-dashboard/dashboard/AcceptedOrders'));
const RejectedOrders = React.lazy(() => import('../pages/farmer-dashboard/dashboard/RejectedOrders'));
const OngoingCrops = React.lazy(() => import('../pages/farmer-dashboard/dashboard/OngoingCrops'));
const TotalCropOrders = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/TotalCropOrders")
);
const TotalTopCrops = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/TotalTopCrops")
);
const TotalOrderSummary = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/TotalOrderSummary")
);
const TotalTransactionHistory = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/TotalTransactionHistory")
);
const Allnotifications = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/Allnotifications")
);
const Mywallet = React.lazy(
  () => import("../pages/farmer-dashboard/dashboard/Mywallet")
);
const AboutCompany = React.lazy(() => import("../pages/farmer-dashboard/dashboard/AboutCompany"));
const Services = React.lazy(() => import("../pages/farmer-dashboard/dashboard/Services"));
const RequestAdvisory = React.lazy(() => import("../pages/farmer-dashboard/dashboard/RequestAdvisory"));
const ServiceDetails = React.lazy(() => import("../pages/farmer-dashboard/dashboard/ServiceDetails"));
const ServicesAndFees = React.lazy(() => import("../pages/farmer-dashboard/dashboard/ServicesAndFees"));
const TermsAndConditions = React.lazy(() => import("../pages/farmer-dashboard/dashboard/TermsAndConditions"));

const FarmRegistration = React.lazy(() => import('../pages/farmer-dashboard/myfarms/FarmRegistration'));
const FarmList = React.lazy(() => import('../pages/farmer-dashboard/myfarms/Farmlist'));
const FarmDetails = React.lazy(() => import('../pages/farmer-dashboard/myfarms/FarmDetails'));
const FarmEdit = React.lazy(() => import('../pages/farmer-dashboard/myfarms/EditFarm'));
const NewSchedule = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/NewSchedule'));
const ScheduleHistory = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/ScheduleHistory'));
const BiologicalAnalysis = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/BiologicalAnalysis'));
const PlantAnalysis = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/PlantAnalysis'));
const WaterAnalysis = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/WaterAnalysis'));
const SoilAnalysis = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/SoilAnalysis'));
const ScheduleDetails = React.lazy(() => import('../pages/farmer-dashboard/myfarms/schedules/ScheduleDetails'));
const ScheduleStageExpenses = React.lazy(
  () =>
    import("../pages/farmer-dashboard/myfarms/schedules/ScheduleStageExpenses")
);
const AddExpense = React.lazy(() => import("../pages/farmer-dashboard/myfarms/schedules/AddExpense"));
const CropVarieties = React.lazy(() => import("../pages/farmer-dashboard/myfarms/schedules/CropVarieties"));
const RequiredMaterial = React.lazy(() => import("../pages/farmer-dashboard/myfarms/schedules/RequiredMaterial"));
const DamageCrop = React.lazy(() => import("../pages/farmer-dashboard/myfarms/schedules/DamageCrop"));
const ScheduleTimeline = React.lazy(() => import("../pages/farmer-dashboard/myfarms/schedules/Timeline"));

const FarmTips = React.lazy(() => import('../pages/farmer-dashboard/myfarms/TipsforFarming'));
const MandiPrices = React.lazy(() => import('../pages/farmer-dashboard/myfarms/MandiPrices'));
const PreventiveCropCare = React.lazy(() => import('../pages/farmer-dashboard/myfarms/CropCare'));
const FarmGuidance = React.lazy(() => import('../pages/farmer-dashboard/myfarms/FarmGuidance'));
const FarmInsurance = React.lazy(() => import('../pages/farmer-dashboard/myfarms/FarmInsurance'));
const WeatherForCast = React.lazy(() => import('../pages/farmer-dashboard/myfarms/WeatherForCast'));

const AgroAdvisory = React.lazy(() => import('../pages/farmer-dashboard/agro-advisors/AgroAdvisory'));
const Advisors = React.lazy(() => import('../pages/farmer-dashboard/agro-advisors/Advisors'));
const AdvisorDetail = React.lazy(() => import('../pages/farmer-dashboard/agro-advisors/AdvisorDetails'));
const AdvisoryProducts = React.lazy(() => import('../pages/farmer-dashboard/agro-advisors/Products'));

const Laboratory = React.lazy(() => import('../pages/farmer-dashboard/laboratory/Laboratory'));
const LaboratoryDetail = React.lazy(() => import('../pages/farmer-dashboard/laboratory/LaboratoryDetails'));

const FarmerBuyProducts = React.lazy(() => import('../pages/farmer-dashboard/products/BuyProducts'));
const ProductDetails = React.lazy(() => import('../pages/farmer-dashboard/products/ProductDetails'));
const FarmerSellProducts = React.lazy(() => import('../pages/farmer-dashboard/products/SellProducts'));
const FarmerBuyProductsHistory = React.lazy(() => import('../pages/farmer-dashboard/products/BuyProductHistory'));
const FarmerSellProductsHistory = React.lazy(() => import('../pages/farmer-dashboard/products/SellProductHistory'));


const ContractFarmingOverview = React.lazy(() => import('../pages/farmer-dashboard/contract-farming/Overview'));
const ContractDetails = React.lazy(() => import('../pages/farmer-dashboard/contract-farming/ContractDetails'));
const NewContracts = React.lazy(() => import('../pages/farmer-dashboard/contract-farming/SearchBuyer'));
const NewContractDetails = React.lazy(() => import('../pages/farmer-dashboard/contract-farming/new-contract-details'));
const ContractsList = React.lazy(() => import('../pages/farmer-dashboard/contract-farming/ContractList'));

const CropSchedule = React.lazy(() => import('../pages/farmer-dashboard/crop-schedule/CropSchedule'));

const CropDoctor = React.lazy(() => import('../pages/farmer-dashboard/crop-doctor/CropDoctor'));
const CropListDetails = React.lazy(() => import('../pages/farmer-dashboard/crop-doctor/CropListDetails'));

const GovScheme = React.lazy(() => import('../pages/farmer-dashboard/extras/GovermentScheme'));
const FinancialServices = React.lazy(() => import('../pages/farmer-dashboard/extras/FinancialServices'));
const TipOfDay = React.lazy(() => import('../pages/farmer-dashboard/extras/TipOfDay'));
const NewsAndJobs = React.lazy(() => import('../pages/farmer-dashboard/extras/NewAndJobs'));
const FarmerFAQ = React.lazy(() => import('../pages/farmer-dashboard/extras/FAQ'));
const FarmerVideos = React.lazy(() => import('../pages/farmer-dashboard/extras/Videos'));
const FarmDoctorHelpline = React.lazy(() => import('../pages/farmer-dashboard/extras/FarmDoctorHelpline'));
const FarmDoctorBuzz = React.lazy(() => import('../pages/farmer-dashboard/extras/Chat/index'));
const CropInsurance = React.lazy(() => import('../pages/farmer-dashboard/extras/CropInsurance'));
const Poll = React.lazy(() => import('../pages/farmer-dashboard/extras/Poll'));
const Campaign = React.lazy(() => import('../pages/farmer-dashboard/extras/Campaign'));
const MyAstro = React.lazy(() => import('../pages/farmer-dashboard/extras/MyAstro'));
const FarmVastu = React.lazy(() => import('../pages/farmer-dashboard/extras/FarmVastu'));
const Covid19 = React.lazy(() => import('../pages/farmer-dashboard/extras/Covid19'));
